...
if valor > 5000000:
    ...
    credito=valor*0.645
    interes=credito*0.2
    print('el total de la compra es',valor,'de la forma en que',propio,'seran de su dinero,',banco,'seran prestados por el banco,',credito,'seran por un credito al fabricante y',interes,'de interes por el credito al fabricante')
